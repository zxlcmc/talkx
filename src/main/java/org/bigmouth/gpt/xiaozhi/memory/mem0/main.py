...
config = {
    "llm": {
        ...
        "config": {
            ...
            "temperature": 0.2,
            "max_tokens": 1000,
            "api_key": "sk-********7zXO1Jw8CPofz",
            "openai_base_url": "https://api.aigateway.work/v1"
        }
    },
    "embedder": {
        "provider": "openai",
...
def update_memory(memory_id: str, updated_memory: str):
