package org.bigmouth.gpt.xiaozhi.aliyun;
...
public class ConnectionOptionWrapper {
    ...
    public ConnectionOptionWrapper(String instanceId, String accessKey, String clientId,
        ...
        mqttConnectOptions.setPassword(StringHelper.convert(builder.toString()));
    ...
    public ConnectionOptionWrapper(String instanceId, String accessKey, String secretKey,
        ...
        mqttConnectOptions.setPassword(StringHelper.convert(Tools.macSignature(clientId, secretKey)));
        mqttConnectOptions.setKeepAliveInterval(90);
        mqttConnectOptions.setAutomaticReconnect(true);
        mqttConnectOptions.setConnectionTimeout(5000);
    }
    ...
    public ConnectionOptionWrapper(String instanceId, String userName, String secret,
        ...
        if (SignMode.SIGNED.equals(signMode)) {
            mqttConnectOptions.setPassword(StringHelper.convert(Tools.macSignature(clientId, secret)));
        } else if (SignMode.ORIGIN.equals(signMode)) {
            mqttConnectOptions.setPassword(StringHelper.convert(secret));
        } else {
